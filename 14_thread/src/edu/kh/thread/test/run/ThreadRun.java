...
public class ThreadRun {
	...
	//쓰레드를 사용해 메인작업과 병렬로 처리할 수 있음
	
	//병렬 처리는 하나의 작업을 여러 부분으로 나누어 동시에 처리하는 것
	public static void main(String[] args) {
		...
		//start나 stop과 같은 Thread용 메서드를 사용할 수 없음
		...
		thread2.start(); //스레드의 실행 메서드
		//스레드가 1초 간격으로 동시 실행되고 있는 것을 확인할 수 있음
		
		
		//실무에서 멀티스레드 사용
		//-웹서버, 데이터베이스 처리, 대규모 데이터 처리 등..
